...
\begin{restatable}{theorem}{ThmNoninterference}
  Any $e : \U{\F{1}} \to \U{\F{2}}$ is weakly, extensionally constant in the sense that for all $x, y : \U{\F{1}}$, if $\kw{profile}(x)\supp$ and $\kw{profile}(y)\supp$, then $\kw{eval}(e~x, \kw{ret}(v))\supp$ and $\kw{eval}(e~y, \kw{ret}(u))\supp$ imply $v = u$. 
\end{restatable}
