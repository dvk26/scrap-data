...
The proof of the fundamental lemma proceeds by induction on the derivation of terms. Details and the proof that formal approximation predicates $- \lhd_{\U{X}} e$ are admissible can be found in the appendix~\cref{app:adequacy}; crucially we rely on the fact that $\kw{eval}(e, v)$ is a $\Sigma$-proposition. 
