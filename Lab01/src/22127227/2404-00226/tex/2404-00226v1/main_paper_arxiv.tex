...
% \author{Tongkun Su \and Jun Li \and Baoliang Zhao \and Qiong Wang \and Haibo Jin \and Faqin Lv \and \\ Hao Chen \and Ying Hu}
% \institute{Shenzhen Institute of Advanced Technology, Chinese Academy of Sciences \and University of Chinese Academy of Sciences \and Technical University of Munich, Munich Center for Machine Learning \and Southern Medical University \and The Hong Kong University of Science and Technology }
%
...
Jun Li\inst{3,}\thanks{The first two authors contributed equally to this work.} \and
Xi Zhang\inst{1,2} \and Haibo Jin\inst{5} \and Hao Chen\inst{5} \and \\ 
Qiong Wang\inst{1,6} \and Faqin Lv\inst{4} \and Baoliang Zhao\inst{1(}\Envelope\inst{)} \and Yin Hu\inst{1(}\Envelope\inst{)}} 
...
\begin{figure}[h!]
    ...
    \includegraphics[width=0.9\textwidth]{ultrasound_intro.pdf}
...
\begin{figure}[t!]
    \centering
    \label{QFT}
    \includegraphics[width=\textwidth]{QFE.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[scale=0.31]{Multimodal_pretraining.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[scale=0.33]{Vision_visualization.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{VQA_detail.pdf}
